...
data <- read.csv('C:/Users/makis/OneDrive/Skrivbord/R_programmering_k_2/cleaned_data_elbilar.csv')
...
#Alternative dataset
data_l <- read.csv("C:/Users/makis/OneDrive/Skrivbord/R_programmering_k_2/skrapning_v3_cleaned.csv")
